...
//  MARK: feetIconsContainer
    private func setupFeetIconsContainer() {
...
//            numberOfLikes.heightAnchor.constraint(equalToConstant: 16.0), //nie trzeba bo bedzie zdefiniowane przez rozmiar fonta
    ...
    private func setupTimeWhenPosted() {
